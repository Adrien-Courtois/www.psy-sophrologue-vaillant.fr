...
const PricingCard = ({ item }) => {
    let FeatherIcon = null;
    if (item.icon)
        FeatherIcon = Icon[humanize(item.icon)];
    return (
            ...
            >
                <div className="flex items-center justify-between">
                    ...
                    {FeatherIcon &&
                        (
                            <span
                                className={`inline-flex h-16 w-16 items-center justify-center rounded-full font-bold ${item.featured
